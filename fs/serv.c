...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	num_read = file_read(o->o_file, ret->ret_buf, req->req_n , o->o_fd->fd_offset);
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	num_write = file_write(o->o_file, req->req_buf, req->req_n , o->o_fd->fd_offset);
	if (num_write <0)
		return num_write;
	//update offset:
	o->o_fd->fd_offset += num_write;
